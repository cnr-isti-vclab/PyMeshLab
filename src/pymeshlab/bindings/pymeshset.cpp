...
void pymeshlab::initMeshSet(pybind11::module& m)
{
	...
	meshSetClass.def("save_current_mesh", &MeshSet::saveCurrentMesh, doc::PYMS_SAVE_CURRENT_MESH, py::arg("file_name"), py::arg("save_textures") = true, py::arg("texture_quality") = -1);
