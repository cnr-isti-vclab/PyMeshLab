...
if(NOT APPLE)
	...
	if(BUILD_DUMMY_BIN_MAC_DEPLOY)
		set(MESHLAB_BIN_INSTALL_DIR ${CMAKE_INSTALL_PREFIX})
		set(MESHLAB_LIB_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/dummybin.app/Contents/Frameworks)
		set(MESHLAB_PLUGIN_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/dummybin.app/Contents/lib/plugins)
	else()
		set(MESHLAB_LIB_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/Frameworks)
		set(MESHLAB_PLUGIN_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/lib/plugins)
	endif()
endif()
