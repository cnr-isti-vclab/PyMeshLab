...
macx {
	...
	QMAKE_POST_LINK += "\
		...
		install_name_tool -change @rpath/QtQml.framework/Versions/5/QtQml @loader_path/lib/QtQml.framework/Versions/5/QtQml $$PYMESHLAB_DISTRIB_DIRECTORY/$${TARGET}.so; \
